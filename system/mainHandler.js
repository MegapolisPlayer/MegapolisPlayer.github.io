...
let WebsiteVersion = "24.2";
//YEAR 24 UPDATE 2 PATCH 0
//IF PATCH IS 0 - DONT WRITE 0
//
...
function CookieBanner() {
	...
	<br>
	<strong>According to the EU directives, strictly necessary cookies may be used without user consent.</strong><br>
	<em>
...
function DropdownGeneration(dirprefix) {
	...
	elem.innerHTML = `
		<h1 id="headermaintext">MartinWeb</h1>
		...
		<span class="headerdrop" id="productdropdown" role="button">
			...
			<div class="headerdropc">
				<button onclick="window.location.href='`+HostName+`/`+dirprefix+`programs.html'" role="button">Programs</button>
				<button onclick="window.location.href='`+HostName+`/`+dirprefix+`onlineapps.html'" role="button">Online</button>
			</div>
			</span>
...
function DropdownSetToIdle(element, dirprefix = "") {
	...
	btnElement.style = "background-color: var(--second-color); color: var(--main-color);";
	//img change
...
function DropdownSetToActive(element, dirprefix = "") {
	...
	//button change
	btnElement = element.getElementsByTagName("button")[0];
	btnElement.style = "background-color: var(--main-color); color: var(--second-color);";
	//img change
	imgElement = btnElement.getElementsByClassName("headerimage")[0];
...
function MakeCredits() {
	...
	elem.innerHTML = `
		<span id="creditsleft">
			<br>
			(c) Martin/MegapolisPlayer, <span class="copyrightyear"></span><br>Website version <span class="websiteversion"></span><br>
		</span>
